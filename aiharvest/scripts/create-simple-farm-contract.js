// 创建一个新脚本来生成SimpleFarm.sol文件
const fs = require('fs');
const path = require('path');

// SimpleFarm合约代码
const simpleFarmCode = `// SPDX-License-Identifier: MIT
...
// 将合约代码写入文件
const contractPath = path.join(__dirname, '../contracts/SimpleFarm.sol');
fs.writeFileSync(contractPath, simpleFarmCode);
console.log(`SimpleFarm合约已创建: ${contractPath}`);